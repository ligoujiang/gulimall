...
import com.pxy.gulimall.member.domain.MemberLoginLog;
import com.pxy.gulimall.member.service.IMemberLoginLogService;
...
public class MemberLoginLogController extends BaseController
{
     ...
     * 查询会员登录记录列表
     */
    //@PreAuthorize("@ss.hasPermi('member:log:list')")
    @GetMapping("/list")
     ...
     * 导出会员登录记录列表
     */
    //@PreAuthorize("@ss.hasPermi('member:log:export')")
     ...
     * 获取会员登录记录详细信息
     */
    //@PreAuthorize("@ss.hasPermi('member:log:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增会员登录记录
     */
    //@PreAuthorize("@ss.hasPermi('member:log:add')")
     ...
     * 修改会员登录记录
     */
    //@PreAuthorize("@ss.hasPermi('member:log:edit')")
     ...
     * 删除会员登录记录
     */
    //@PreAuthorize("@ss.hasPermi('member:log:remove')")
