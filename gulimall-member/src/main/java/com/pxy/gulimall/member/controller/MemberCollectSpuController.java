...
import com.pxy.gulimall.member.domain.MemberCollectSpu;
import com.pxy.gulimall.member.service.IMemberCollectSpuService;
...
public class MemberCollectSpuController extends BaseController
{
     ...
     * 查询会员收藏的商品列表
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:list')")
    @GetMapping("/list")
     ...
     * 导出会员收藏的商品列表
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:export')")
     ...
     * 获取会员收藏的商品详细信息
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:query')")
    @GetMapping(value = "/{id}")
    public AjaxResult getInfo(@PathVariable("id") Long id)
    {
        return success(memberCollectSpuService.selectMemberCollectSpuById(id));
    }

    /**
     * 新增会员收藏的商品
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:add')")
     ...
     * 修改会员收藏的商品
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:edit')")
     ...
     * 删除会员收藏的商品
     */
    //@PreAuthorize("@ss.hasPermi('member:spu:remove')")
